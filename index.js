...
<html lang="en">
  ...
  <body ${bodyAttr}${config.backgroundColor
    ...
    ${body}
    <link rel="stylesheet" href="/plugins/public/any-bootstrap-theme${features?.version_plugin_serve_path
    ...
    <script src="/static_assets/${db.connectObj.version_tag
    }/jquery-3.6.0.min.js"></script>
    ${features && features.bootstrap5
      ? `<script src="/plugins/public/any-bootstrap-theme/bootstrap.bundle.min.js"></script><script src="/plugins/public/any-bootstrap-theme/popper.min.js"></script>`
      : `
